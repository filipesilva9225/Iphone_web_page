function Footer() {
  ...
  const buttonLinks = ["Política e Privacidade", "Termos de Uso", "Vendas"];
        ...
        <div className="border-t border-gray-800 pt-6">
          <div className="flex flex-row md:flex-row justify-between items-center gap-4">
            <p className="text-md text-gray-500">
              Copyright Apple © Apple Inc. Todos os direitos reservados.
            </p>
            <div className="flex gap-6 text-sm text-white">
              {buttonLinks.map((buttonLinks, buttonsLinksIndex) => (
                <a className="hover:text-gray-500" key={buttonsLinksIndex}>
                  {buttonLinks}
                </a>
              ))}
            </div>
